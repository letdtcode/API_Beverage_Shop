...
public class WishClientController {
    ...
    @GetMapping("/wishitems/current")
    public ResponseEntity<?> getCurrentWishItemOfUser(@Param("userId") Long userId) {
        return ResponseEntity.ok(wishService.getCurrentWishItemOfUser(userId));
    }
